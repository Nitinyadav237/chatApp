...
const ChatFooter = () => {
    ...
    const { isTyping, editMsg, setEditMsg, inputText, setInputText, setAttachment, attachmentPreview, setAttachmentPreview, data } = useChatContext();
            ...
            <div className="flex items-center bg-c1/[0.5] p-2 rounded-xl relative">
                ...
                <div className="shrink-0">
                    ...
                    <label htmlFor='fileUploader'>
                        <Icon size="large" icon={<CgAttachment size={20}
                            className="text-c3"
                        />}
                        />
                    </label>
                ...
                <div className="shrink-0 relative">
                    ...
                    {showImojiPicker && (
                        ...
                        >
                            <div className="absolute bottom-1/2 left-0 shadow-lg">
                ...
                {editMsg && (
                    <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-c4 flex items-center gap-2 py-2
                     px-4 pr-2 rounded-full text-sm font-semibold cursor-pointer shadow-lg"
